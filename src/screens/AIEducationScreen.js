...
export default function AIEducationScreen() {
  ...
  return (
    <ScreenWrapper title="AI Clinical Assistant" subtitle="AI-powered clinical reference" icon="robot">
      <View style={styles.banner}>
        ...
        <Text style={styles.bannerText}>AI responses are decision-support aids only. Always apply clinical judgement and verify against current protocols and guidelines.</Text>
      </View>
