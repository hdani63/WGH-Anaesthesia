...
const TOOLS = [
  ...
  { key: 'Resources', icon: 'globe', title: 'Guidelines & Websites', badge: 'External Links', bgColor: BLUE, keywords: 'guidelines websites links external hse cai college anaesthesiologists ireland association anaesthetists rcoa das asra nice resuscitation council resources reference' },
