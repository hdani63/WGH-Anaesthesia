...
const notes = [
  'AHA 2020 Guidelines. Quick reference only — always follow your institution\'s protocols.',
];
...
export default function ACLSScreen() {
  ...
  return (
    <ScreenWrapper title="ACLS Algorithms" subtitle="American Heart Association 2020 Guidelines & Emergency Protocols">
